...
export const metadata = {
    title: 'JSFamily - Personal Blog TailwindCSS Next.js Template',
    description: 'JSFamily - Personal Blog TailwindCSS Next.js Template',
}

export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body className={`${inter.className} bg-neutral-0 dark:bg-neutral-dark-0`}>{children}</body>
    </html>
  );
}
